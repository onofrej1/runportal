"use client";
import { Info, Table, UserPlus, Users } from "lucide-react";
        ...
        <div className="max-w-sm p-6 border-t-green-700 border-t-4 bg-white border border-gray-200 rounded-lg shadow-sm">
          ...
          <div className="p-2 w-full">
            <div className="bg-gray-100 rounded flex p-4 h-full items-center">
                <Info />
              <span className="ml-4 font-medium">Informacie</span>
            </div>
          </div>
          <div className="p-2 w-full">
            <div className="bg-gray-100 rounded flex p-4 h-full items-center">
                <Users />
              <span className="ml-4 font-medium">Zoznam prihlasenych</span>
            </div>
          </div>
          <div className="p-2 w-full">
            <div className="bg-gray-100 rounded flex p-4 h-full items-center">
              <UserPlus />
              <span className="ml-4 font-medium">Registracia</span>
            </div>
          </div>
          <div className="p-2 w-full">
            <div className="bg-gray-100 rounded flex p-4 h-full items-center">
              <Table />
              <span className="ml-4 font-medium">Kategorie</span>
            </div>
          </div>
        </div>
